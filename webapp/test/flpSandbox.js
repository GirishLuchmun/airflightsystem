		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#fioribootcampairflightsystem-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioribootcampairflightsystem-display": {
								"semanticObject": "fioribootcampairflightsystem",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiori.bootcamp.airflightsystem",
									"url": sap.ui.require.toUrl("fiori/bootcamp/airflightsystem")
								}
							}
						}
					}
